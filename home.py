...
users_data = {}
msg_count = 0
file = open(r"C:\Users\ASUS\Desktop\chat_app\chatapp\msg_id.txt", "r")
...
def user_handle(user_id):
    ...
    for msg in consumer:
        ...
        if user_id in users_data:
            ...
            # You can continue adding the remaining "elif" blocks for other operations
...
def fetch_user(user_id):
    global users_data
    file = open(r"C:\Users\ASUS\Desktop\chat_app\chatapp\users.txt", "r")
    data = file.readlines()
...
def fetch_group(user_id):
    global users_data
    file = open(r"C:\Users\ASUS\Desktop\chat_app\chatapp\groups.txt", "r")
    data = file.readlines()
